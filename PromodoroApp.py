...
if (__name__ == "__main__"): 
  ...
  enterTask = Label(window, text = "Enter your task", bg = "light green", font=('arial', 20, 'bold'))
  insertField = Entry(window)
  
  Submit = Button(window, text = "Submit", fg = "blue", bg = "red",font=('arial', 12, 'bold'), command = insertTask) 

  TextArea = Text(window, height = 4, width = 25, font = "arial 13")

  taskNumber = Label(window, text = "Specify the task number that you want to remove, below", bg = "cadet blue", font = ('arial', 13, 'bold'))
